...
![Components](../images/21_components.png)
...
![Wiring Diagram](../images/21_wiring_diagram.png)
...
![Schematic Diagram](../images/21_schematic_diagram.png)
...
- Use `lcd.clear()` between updates if old text doesn't fully clear when a new string is shorter.
- Display values from other projects — try printing the [Thermometer](../03_sensors/13_thermometer.md)'s temperature reading here instead of a counter.
