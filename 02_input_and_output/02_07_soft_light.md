...
adc.width(ADC.WIDTH_12BIT)
```
PWM on GPIO14 drives the LED; the ADC on GPIO1 reads the potentiometer, same as in [Read the Voltage of a Potentiometer](./02_input_and_output/02_06_read_voltage_potentiometer.md).
