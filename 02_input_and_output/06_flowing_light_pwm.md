...
*Same board and LED bar graph as [Flowing Light](./05_flowing_light.md), but only 8 of the 10 LEDs are wired — one fewer jumper/resistor pair than the GPIO count, since only 8 PWM channels are available.*

![Components](../images/05_components.png)
...
![Wiring Diagram](../images/06_wiring_diagram.png)

### Schematic Diagram

![Schematic Diagram](../images/06_schematic_diagram.png)
